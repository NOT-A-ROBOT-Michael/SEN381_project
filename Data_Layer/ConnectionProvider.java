...
public class ConnectionProvider {
    ...
    public Client_Details getClientDetails(Integer clientID)// throws 
    {
 ...
 public ArrayList<TechnicianTask> GetTechTasks(String Email)throws ClassNotFoundException
    ...
    String sql = "SELECT \"Priority\", \"Status\", \"Requested_Date\", \"ServiceID\" FROM \"TechTaskPageView\" WHERE \"Email\" ="+ "'"+Email+"'";    
        try (Connection conn = getCon();
           ...
           ArrayList<TechnicianTask> TaskList = new ArrayList<>(); 

            // Populates the list with User objects
            while (rs.next())
            {
                System.out.println("Hello got a service for the technician");
                //Initialize
    ...
    if (rs2.next()) {
        ...
        public TechnicianDetails ViewTechDetails(String techEmail) throws ClassNotFoundException
        {
      ...
      public boolean SaveNotes(Notes note) throws ClassNotFoundException
       {
           try{
