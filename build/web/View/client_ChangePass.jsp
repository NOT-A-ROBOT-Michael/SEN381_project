...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="./CSS/changePassStyling.css"/>
    </head>
    <body>
        <header>
        ...
        <section id="section-container">
            ...
            <div id="main-container">
                <form name="change-pass" action="changePassword" method="POST" id="change-pass">
                    
                    <h1 id="block-title">Change Password:</h1>
                    ...
                    <%
                        ...
                        if(messageInfo != null)
                        {
                            ...
                            String color = messageInfo[1];
                            
                            out.write("<h2 id=\"warning\" style = \"color : " + color +"\">" + text + "</h2>");
                        }
                    %>
                    
                    <div id="pass-container">
                        
                        <label for="old-pass"><p class="key">Current Password:</p></label>
                        <input type="password" name="old-pass" value="" size="15" class="value"/>
                        <label for="new-pass"><p class="key">New Password:</p></label>
                        <input type="password" name="new-pass" value="" size="15" class="value"/>
                        
                    </div>
                    <div id="btn-container">
                        <input type="submit" value="Submit" name="btn_submit" class="btn"/>
                    </div>
